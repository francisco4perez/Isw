...
;(function ($, window){
    ...
    Rate.prototype.build = function()
    {
        ...
        if ($(this.element).attr("data-rate-input"))
        {
            this.input = $(this.element).attr("data-rate-input");

            if(this.settings.update_input_field_name == undefined){
                this.settings.update_input_field_name = $(this.input);
            }
